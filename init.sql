...
-- Create a table to store registered domains and their associated API keys or tokens
...
CREATE INDEX IF NOT EXISTS idx_registered_domains_api_key ON registered_domains(api_key);
